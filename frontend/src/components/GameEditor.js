...
const CHALLENGE_CONFIGS = {
  ...
  icon_search: {
    defaults: { gridCols: 6, gridRows: 8, targetCount: 1, uniqueSymbols: 6, symbolSet: 'arrows', questionCount: 5 },
    fields: [
      ...
      { key: 'uniqueSymbols', labelKey: 'uniqueSymbols', type: 'number', min: 3, max: 12 },
